...
**Started:** P3-01 (fire API token + POST-only fire), P3-02 (ignore profile `allowedCommands` on apply), and P3-03 (value-fingerprint shell allowlist) remediated. Remaining: P3-04…P3-09.
