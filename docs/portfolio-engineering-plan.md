...
**Started:** P3-01…P3-07 remediated (fire token, profile allowlist scrub, value-fingerprint shell allowlist, ydotool `0600`, GitHub-only git remotes, import path confinement, save_store allowlist gate). Remaining: P3-08…P3-09.
