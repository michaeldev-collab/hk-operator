...
- [x] Phase 4 start — P3-01…P3-07 (fire token, allowlist scrub, value-bound shell, ydotool 0600, GitHub-only remotes, import path confinement, save_store allowlist gate)
